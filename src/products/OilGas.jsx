        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              ...
              <div className="p-6 md:p-8">
                <div className="w-14 h-14 md:w-16 md:h-16 bg-amber-100 rounded-2xl flex items-center justify-center mb-5 md:mb-6 text-amber-600">
                  <FaOilCan size={28} className="md:w-8 md:h-8" />
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">Surface Production</h3>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              ...
              <div className="p-6 md:p-8">
                <div className="w-14 h-14 md:w-16 md:h-16 bg-amber-100 rounded-2xl flex items-center justify-center mb-5 md:mb-6 text-amber-600">
                  <FaIndustry size={28} className="md:w-8 md:h-8" />
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">Gas Processing Plants</h3>
                <p className="text-gray-600 mb-4 text-sm md:text-base">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              ...
              <div className="p-6 md:p-8">
                <div className="w-14 h-14 md:w-16 md:h-16 bg-amber-100 rounded-2xl flex items-center justify-center mb-5 md:mb-6 text-amber-600">
                  <FaWater size={28} className="md:w-8 md:h-8" />
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">Floating Production</h3>
                <p className="text-gray-600 mb-4 text-sm md:text-base">
            ...
            <div className="lg:w-1/2 transition-all duration-700"
              ...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-6 md:p-8 text-white shadow-xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold">Midstream Infrastructure</h3>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                    ...
                    <p className="text-xs md:text-sm text-gray-300">Onshore & offshore pipelines, flow assurance, and integrity management.</p>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                    <div className="font-semibold text-amber-400 mb-2 text-sm md:text-base">Compressor & Pump Stations</div>
                    <p className="text-xs md:text-sm text-gray-300">High-efficiency compression and pumping solutions.</p>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                    <div className="font-semibold text-amber-400 mb-2 text-sm md:text-base">Storage Facilities</div>
                    <p className="text-xs md:text-sm text-gray-300">Tank farms, cavern storage, and LNG terminals.</p>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4 backdrop-blur-sm">
                    <div className="font-semibold text-amber-400 mb-2 text-sm md:text-base">Metering & Automation</div>
                    <p className="text-xs md:text-sm text-gray-300">Custody transfer, fiscal metering, and SCADA integration.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="lg:w-1/2 transition-all duration-700"
              ...
              <div className="bg-amber-50 rounded-2xl p-6 md:p-8 border border-amber-100">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl md:text-2xl font-bold text-gray-900">Project Lifecycle Support</h3>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mt-6">
                  <span className="bg-amber-200 text-amber-900 px-3 py-1 rounded-full text-xs md:text-sm font-medium">FEED Studies</span>
                  <span className="bg-amber-200 text-amber-900 px-3 py-1 rounded-full text-xs md:text-sm font-medium">Detailed Engineering</span>
                  ...
                  <span className="bg-amber-200 text-amber-900 px-3 py-1 rounded-full text-xs md:text-sm font-medium">Construction Supervision</span>
