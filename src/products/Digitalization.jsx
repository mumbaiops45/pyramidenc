...
import {
  FaMobileAlt, FaChartLine, FaRobot, FaCogs, FaLink,
  FaBrain, FaTachometerAlt, FaUsers, FaMoneyBillWave,
  FaHeadset, FaShieldAlt, FaBolt, FaGlobe, FaArrowRight
} from 'react-icons/fa';
import { GiArtificialIntelligence, GiDigitalTrace } from 'react-icons/gi';
import { Link } from "react-router-dom";
...
const Digitalization = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Digitalization Program Roadmap with fade-in */}
      ...
      {/* 24/7 Support & Remote Management Section with fade-in */}
      ...
      <section className="bg-gradient-to-br from-amber-200 via-amber-50 to-white py-20 lg:py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-3xl lg:text-5xl font-extrabold mb-6 leading-tight text-gray-900">
            Unlock real-time insights & operational control
          </h2>
