...
const Digitalization = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Digitalization Program Roadmap – Updated header */}
      <section ref={roadmapRef} className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Operator Training Simulator – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            ...
            {/* Process Digital Twin – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            ...
            {/* Mechanical Digital Twin – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            ...
            {/* Data Linkage with Plant Control System – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            ...
            {/* Real Time Performance Simulations – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            ...
            {/* AI Techniques to Predict Plant Performance – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            ...
            {/* Performance Dashboard for Top Management – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            ...
            {/* Physical Operation Support – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
            ...
            {/* Performance-based Revenue Model – unchanged */}
            <div className="bg-white rounded-xl p-6 shadow-sm border-l-4 border-amber-500 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1"
      ...
      {/* 24/7 Support & Remote Management Section – unchanged (no header) */}
            ...
            <div className="lg:w-1/2 transition-all duration-700"
              ...
              <div className="bg-amber-50 rounded-2xl p-8 border border-amber-100">
                ...
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2"><span className="text-amber-500 mt-1">▹</span><span>Real-time process optimization</span></li>
                  <li className="flex items-start gap-2"><span className="text-amber-500 mt-1">▹</span><span>Remote performance management via handheld devices</span></li>
                  <li className="flex items-start gap-2"><span className="text-amber-500 mt-1">▹</span><span>Complete stakeholder controls while on the move</span></li>
                </ul>
