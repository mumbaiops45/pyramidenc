...
const SyngasDerivatives = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Key Derivatives – Updated header */}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4">Complete hydrogen solutions from production to storage and distribution.</p>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4">End-to-end ammonia synthesis, storage, and handling infrastructure.</p>
                <ul className="space-y-2 text-gray-600">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4">Methanol production units tailored to global market demands.</p>
                <ul className="space-y-2 text-gray-600">
      ...
      {/* Engineering Expertise Section – Updated header */}
      <section ref={expertiseRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Expertise cards – unchanged */}
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm border-l-4 border-amber-500 transition-all duration-700"
      ...
      {/* Project Support Section – unchanged (no header) */}
      <section ref={supportRef} className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6 text-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm transition-all duration-700"
              ...
              <div className="text-amber-600 text-4xl mb-3 flex justify-center"><FaLeaf /></div>
