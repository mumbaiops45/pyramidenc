      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-xs font-semibold tracking-[3px] uppercase text-amber-600">
              Global Reach
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {markets.map((market, idx) => (
            <div
              key={idx}
              className="bg-white border border-gray-200 rounded-xl p-6 text-center transition-all duration-300 hover:border-amber-300 hover:shadow-lg hover:-translate-y-2 group"
            >
              {/* Flag */}
              <div className="flex justify-center mb-4">
              ...
              {/* Title */}
              <h3 className="text-gray-900 font-semibold text-lg mb-2 group-hover:text-amber-600 transition-colors">
                {market.name}
              </h3>
              ...
              {/* Hover Line */}
              <div className="mt-4 h-[2px] w-0 bg-amber-500 group-hover:w-full transition-all duration-300 mx-auto"></div>
            </div>
          ))}
        </div>
