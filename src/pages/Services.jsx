...
//   return (
//       <section className="max-w-7xl mx-auto border-y border-border my-16 rounded-2xl overflow-hidden">
//       <div className="grid grid-cols-1 lg:grid-cols-2">
//         {/* Left side – Service list */}
//         <div className="px-6 lg:px-12 xl:px-14 py-12 lg:py-16 border-b lg:border-b-0 lg:border-r border-border bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
...
//         <div className="px-6 lg:px-12 xl:px-14 py-12 lg:py-16 flex flex-col justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
//           <div className="flex items-center gap-2 mb-3">
//             <span className="w-6 h-0.5 rounded bg-primery" />
//             <span className="text-[11px] font-semibold tracking-[3px] uppercase text-primery">
//               Our Process
...
//           <p className="text-sm font-light leading-relaxed mb-8 text-gray-300">
    ...
    <section className="max-w-7xl mx-auto border-y border-border my-16 rounded-2xl overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div>
            {services.map((svc, i) => (
              <div
                ...
                onMouseLeave={() => setActiveIdx(null)}
              >
                <span className="text-xs font-black w-8 flex-shrink-0 text-primery/50">
                  0{i + 1}
                </span>
                ...
                <span
                  className={`text-base text-primery transition-all ${
                    activeIdx === i
        ...
        <div className="px-6 lg:px-12 xl:px-14 py-12 lg:py-16 flex flex-col justify-center bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
          ...
          <p className="text-sm font-light leading-relaxed mb-8 text-gray-300">
            We manage every stage of the project lifecycle — research, engineering, procurement,
            fabrication, and handover — under one roof.
          </p>
      ...
      <style>
        {`
          ...
          .animate-scroll-x {
            animation: scrollX 6s ease-in-out infinite;
          }
        `}
      </style>
