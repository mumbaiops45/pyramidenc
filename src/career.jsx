...
//     // Check other required fields (OTP, country, jobType, experience, city, position, dateOfBirth, resume)
...
//                             <FaExclamationCircle size={10} /> {errors.fullName}
//                           </p>
//                         )}
//                       </div>
...
//                           <p className="text-red-500 text-xs mt-1 flex items-center gap-1">
//                             <FaExclamationCircle size={10} /> {errors.phone}
//                           </p>
//                         )}
//                       </div>
//                     </div>
...
//                     <button type="submit"  className="w-full bg-amber-500 hover:bg-amber-600 text-white font-semibold py-3 rounded-lg transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
//                       {isSubmitting ? "Submitting..." : "Submit Application"} <FaArrowRight className="text-sm" />
//                     </button>
//                   </form>
//                 </div>
...
const Career = () => {
  ...
  useEffect(() => {
    ...
    // ❌ Removed `setFormValid` because it's not used
  }, [formData.fullName, formData.email, formData.phone, touched]);
                ...
                <div className="p-6 md:p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-gray-700 text-sm font-medium mb-1">Enter OTP *</label>
                        <input type="text" name="otp" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition" value={formData.otp} onChange={handleChange} required />
                      </div>
                      <div>
                        <label className="block text-gray-700 text-sm font-medium mb-1">Phone Number *</label>
                        <input
