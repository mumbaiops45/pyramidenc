...
// ============================================================================
// Animation styles (bubbles, fades, shimmer) – using brighter yellow
// ============================================================================
const animationStyles = `
  @keyframes fadeUp {
    0% { opacity: 0; transform: translateY(30px); }
...
const Epc = () => {
  ...
  // const brightYellowLight = "#FEF08A";
  // const brightYellowDark = "#EAB308";

  return (
    <div className="bg-white">
      <style>{animationStyles}</style>

      {/* Hero Section – centered text, bright yellow gradient */}
      <section className="relative overflow-hidden text-white">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950"></div>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {heroBubbles.map((bubble) => (
            <div
              key={bubble.id}
              className="absolute rounded-full bg-gradient-to-tr from-yellow-400/30 to-yellow-500/10"
              style={{
                width: `${bubble.size}px`,
                height: `${bubble.size}px`,
                left: `${bubble.left}%`,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 text-center">
          <div className="inline-flex items-center justify-center gap-2 text-sm text-gray-200 mb-6 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full mx-auto w-fit animate-fadeLeft">
            <span>Home</span><span>›</span><span>Services</span><span>›</span>
            <span className="text-yellow-400 font-medium">Turnkey EPC Services</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 animate-fadeUp delay-100">
            Turnkey{" "}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="inline-block px-4 py-1 rounded-full bg-yellow-100 text-yellow-700 text-sm font-semibold mb-4 animate-fadeUp">
            End‑to‑End Delivery
          </div>
          <p className="text-gray-700 text-lg leading-relaxed animate-fadeUp delay-100">
            Pyramid E&C provides complete turnkey EPC solutions for oil & gas, refining, petrochemical,
      ...
      {/* Image Section – split layout with bright yellow accents */}
      <section ref={imageSectionRef} className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center transition-all duration-700"
          ...
          <div className="order-2 md:order-1">
            <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Integrated Project Delivery</h3>
      ...
      {/* Features Section – left border with bright yellow */}
      <section ref={featuresRef} className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 transition-all duration-700"
            style={{ opacity: featuresInView ? 1 : 0, transform: featuresInView ? "translateY(0)" : "translateY(30px)" }}>
            <div className="inline-block px-4 py-1 rounded-full bg-yellow-100 text-yellow-700 text-sm font-semibold mb-3">
              Why Choose Us
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Turnkey EPC Capabilities</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group border-l-4 border-yellow-200 pl-5 py-2 transition-all duration-300 hover:border-yellow-500 hover:pl-6"
                style={{
                  opacity: featuresInView ? 1 : 0,
                  transform: featuresInView ? "translateY(0)" : "translateY(30px)",
                  transitionDelay: `${idx * 0.1}s`,
              ...
              >
                <feature.icon className="text-3xl text-yellow-500 mb-3 group-hover:text-yellow-600 transition-colors" />
      ...
      {/* Phases Section – step numbers with bright yellow */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {phases.map((phase, idx) => (
              <div
                key={idx}
                className="group border-l-4 border-yellow-300 pl-5 py-2 transition-all duration-300 hover:border-yellow-500 hover:pl-6"
                style={{
                  opacity: phasesInView ? 1 : 0,
                  transform: phasesInView ? "translateY(0)" : "translateY(40px)",
                  transitionDelay: `${idx * 0.1}s`,
              ...
              >
                <div className="text-5xl font-black text-yellow-200 group-hover:text-yellow-300 transition-colors mb-2">
                  {phase.step}
                </div>
                <phase.icon className="text-2xl text-yellow-500 mb-3 group-hover:text-yellow-600" />
      ...
      {/* Benefits Section – top border with bright yellow */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, idx) => (
              <div
                key={idx}
                className="border-t-2 border-gray-200 pt-4 transition-all duration-300 hover:border-yellow-400"
                style={{
                  opacity: benefitsInView ? 1 : 0,
                  transform: benefitsInView ? "translateY(0)" : "translateY(30px)",
                  transitionDelay: `${idx * 0.1}s`,
              ...
              >
                <benefit.icon className="text-3xl text-yellow-500 mb-3" />
                <h3 className="text-xl font-bold text-gray-900 mb-2">{benefit.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">{benefit.description}</p>
              </div>
            ))}
      ...
      {/* CTA Section – bright yellow gradient */}
      <section className="bg-gradient-to-br from-yellow-200 via-yellow-50 to-white py-20 lg:py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            <span className="w-8 h-[2px] bg-yellow-600"></span>
            <span className="text-xs font-semibold tracking-[3px] uppercase text-yellow-700">
              Ready for a Single‑Point Solution?
            </span>
          </div>
          <h2 className="text-3xl lg:text-5xl font-extrabold mb-6 leading-tight text-gray-900">
          ...
          <Link
            to="/contact"
            className="inline-flex px-8 py-3 rounded-full text-sm font-semibold text-white bg-yellow-500 hover:bg-yellow-600 transition-all duration-300 shadow-lg"
          >
            Contact Our EPC Team →
          </Link>
        </div>
