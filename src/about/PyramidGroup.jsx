...
//       {/* Intro Section – with updated header */}
//       <section className="py-20 bg-white overflow-hidden">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div
//             ref={introRef}
...
//       {/* Regional Leadership – updated header */}
//       <section className="py-20 bg-gray-50">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="text-center mb-12 animate-fadeUp">
//             {/* Pill badge */}
...
//       {/* Global Footprint – updated header */}
//       <section className="py-20 bg-gray-50 overflow-hidden">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="text-center mb-12 animate-fadeUp">
//             {/* Pill badge */}
...
//               </span>
//             </h2>
//             <div className="w-16 h-0.5 bg-[var(--primery)] mx-auto mt-4 rounded-full"></div>
//             <p className="text-gray-600 max-w-2xl mx-auto mt-4">Strategic offices across five continents</p>
//           </div>
...
//       {/* Vision & Research – updated header */}
//       <section className="py-20 bg-white relative overflow-hidden">
//         <div className="absolute inset-0 bg-gradient-to-r from-amber-50 via-transparent to-amber-50"></div>
//         <div
//           ref={visionRef}
...
//       {/* CTA Section – updated badge + heading */}
//       <section className="relative overflow-hidden bg-gradient-to-br from-amber-200 via-amber-50 to-white py-20 lg:py-24 px-6">
//         <div className="absolute inset-0 overflow-hidden pointer-events-none">
//           {ctaBubbles.map((bubble) => (
//             <div
