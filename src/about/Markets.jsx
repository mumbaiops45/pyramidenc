...
// ============================================================
// Competence Card – Modern glass card with gradient border on hover
// ============================================================
function CompetenceCard({ title, description, icon: Icon, index }) {
  const [ref, inView] = useInView();
  const [hovered, setHovered] = useState(false);
  ...
  return (
    ...
    >
      <div
        onMouseEnter={() => setHovered(true)}
        onMouseLeave={() => setHovered(false)}
        className="group relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 h-full overflow-hidden border border-white/20"
        style={{
          transform: hovered ? "translateY(-6px)" : "translateY(0)",
        }}
      >
        {/* Animated gradient border on hover */}
        <div className="absolute inset-0 rounded-2xl p-[1px] bg-gradient-to-br from-amber-400/0 via-orange-400/0 to-amber-500/0 group-hover:from-amber-400/60 group-hover:via-orange-400/40 group-hover:to-amber-500/60 transition-all duration-500 pointer-events-none" />

        <div className="p-6 relative">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center mb-4 transition-all duration-500 group-hover:from-amber-500 group-hover:to-amber-600 group-hover:shadow-lg">
            <Icon className="text-2xl text-amber-600 group-hover:text-white transition-colors duration-300" />
          </div>
...
// ============================================================
// Animation keyframes (modern, smooth)
// ============================================================
const animationStyles = `
  @keyframes fadeUp {
    0% { opacity: 0; transform: translateY(30px); }
...
// ============================================================
// Main Markets Component (Professional Redesign)
// ============================================================
const Markets = () => {
  const [valueChainRef, valueChainInView] = useInView();
  ...
  return (
    <div className="bg-gradient-to-b from-slate-50 to-white">
      ...
      {/* Hero Section – Minimalist with abstract shapes */}
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-amber-400/10 rounded-full blur-2xl"></div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center">
          <div className="inline-flex items-center justify-center gap-2 text-sm text-gray-300 mb-6 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mx-auto w-fit animate-fadeIn">
            <span>Home</span><span>›</span><span>About</span><span>›</span>
            <span className="text-amber-300 font-medium">Our Markets</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight mb-6 animate-fadeUp delay-100">
            Our{" "}
            <span
      ...
      {/* Competence Groups – Sleek cards with hover depth */}
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
      ...
      {/* Market Dynamics & Innovation – Split layout with modern cards */}
      <section className="py-20 px-6 relative z-10 bg-white border-t border-gray-100">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <div className="grid grid-cols-2 gap-5">
                {[
                  { icon: FaSolarPanel, label: "Solar Integration", color: "from-yellow-500 to-amber-500" },
                  { icon: FaLeaf, label: "Low Carbon Emission", color: "from-green-500 to-emerald-500" },
                  { icon: FaTools, label: "Minimal Footprint", color: "from-blue-500 to-cyan-500" },
                  { icon: FaCogs, label: "Modular Process Plants", color: "from-indigo-500 to-purple-500" },
                ].map(({ icon: Icon, label, color }, i) => (
                  <div key={i} className="group bg-gray-50 rounded-2xl p-5 text-center border border-gray-100 hover:border-transparent hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${color} flex items-center justify-center mx-auto mb-3 shadow-md group-hover:scale-110 transition-transform duration-300`}>
      ...
      {/* Value Chain & Fabrication – Clean two-column with floating icons */}
      <section ref={valueChainRef} className="py-20 px-6 relative z-10 bg-slate-50">
        <div
          className="max-w-6xl mx-auto transition-all duration-700"
          style={{
            opacity: valueChainInView ? 1 : 0,
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900">Strong Value Chain & In-House Fabrication</h3>
            <div className="w-16 h-0.5 bg-gradient-to-r from-amber-500 to-orange-500 mx-auto rounded-full mt-3 mb-3"></div>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Besides investing in technology and specialization, Pyramid E&C maintains a strong value chain to control product quality and remain competitive.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-6 border border-gray-100 hover:border-amber-200 transition-all shadow-sm hover:shadow-lg group">
              <div className="w-12 h-12 rounded-xl bg-amber-100 flex items-center justify-center mb-4 group-hover:bg-amber-500 transition-colors duration-300">
                <FaHardHat className="text-2xl text-amber-600 group-hover:text-white" />
              </div>
              <h4 className="text-xl font-semibold text-gray-900 mb-2">High-Value Engineering</h4>
              <p className="text-gray-600 text-sm">Our robust in-house engineering team delivers detailed design, process optimization, and digital twins for complex hydrocarbon facilities.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 border border-gray-100 hover:border-amber-200 transition-all shadow-sm hover:shadow-lg group">
              <div className="w-12 h-12 rounded-xl bg-amber-100 flex items-center justify-center mb-4 group-hover:bg-amber-500 transition-colors duration-300">
                <FaShip className="text-2xl text-amber-600 group-hover:text-white" />
              </div>
              <h4 className="text-xl font-semibold text-gray-900 mb-2">Modular Fabrication Yard</h4>
              <p className="text-gray-600 text-sm">We have our own robust modular fabrication facilities, offering great control over quality and schedule of process plants.</p>
            </div>
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4 text-center">
            {["Quality Control", "Schedule Assurance", "Cost Competitiveness"].map((label, i) => (
              <div key={i} className="flex items-center gap-2 text-sm text-gray-600 bg-white px-4 py-2 rounded-full shadow-sm">
                <FaCheckCircle className="text-amber-500" />
                <span>{label}</span>
              </div>
            ))}
      ...
      {/* CTA Section – Modern gradient with floating effect */}
      <section className="relative py-20 lg:py-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-xs font-semibold tracking-[3px] uppercase text-white/80">
              Partner with Pyramid E&C
            </span>
          </div>
          <h2 className="text-3xl lg:text-5xl font-extrabold mb-6 leading-tight text-white">
            Let us help you accelerate your financial goals
          </h2>
          <p className="text-amber-50 text-sm lg:text-base max-w-2xl mx-auto mb-10">
            With our technology, engineering, and operational expertise.
          </p>
          <Link
            to="/contact"
            className="inline-flex px-8 py-3 rounded-full text-sm font-semibold text-amber-700 bg-white hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
            Contact Our Experts →
          </Link>
        </div>
