...
//       {/* CTA Section – Light yellow gradient (matching CTA component) */}
  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div
          className="absolute bottom-3 left-4 text-3xl font-black text-white"
...
const History = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Timeline Section – Grid of Cards */}
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
