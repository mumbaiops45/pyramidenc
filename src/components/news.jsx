...
const News = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* News Grid – Responsive: 1,2,3,4 columns */}
      <section ref={newsRef} className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {sortedNews.map((item, idx) => (
              ...
              >
                <div className="h-full bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-gray-100">
                  {/* Top accent bar */}
                  ...
                  <div className="p-5">
                    ...
                    {/* Title */}
                    <h3 className="text-base font-bold text-gray-900 mb-2 group-hover:text-amber-600 transition-colors line-clamp-2">
                      {item.title}
                    </h3>
